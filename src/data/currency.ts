import {Currency, CurrencyFilter, CurrencyType} from "../intefaces/Interfaces";

export const currency: Currency[] = [
    {
        code: "BTC",
        name: "Bitcoin BTC ",
        category: CurrencyType.CRYPTOCURRENCY,
    },
    {
        code: "ETH",
        name: "Ethereum ETH ",
    ...
    },
    {
        code: "ACRUB",
        name: "Альфа-банк RUB ",
        category: CurrencyType.RUS_BANKS,
    },
    {
        code: "SBERRUB",
        name: "Сбербанк RUB ",
